...
const styles = StyleSheet.create({
  ...
  container: { width: '90%', backgroundColor: 'white', borderRadius: 16, padding: 16 },
  ...
  editorHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  ...
  cancel: { backgroundColor: '#f8f9fa', borderWidth: 1, borderColor: '#e5e7eb' },
